...
function Home({ navigate, meta, roomId = "combat" }) {
  ...
  // ======================================================
// HOME — MOBILE LANDSCAPE GATE
// Retorno temprano para celular horizontal.
// Evita offset visual del Home mobile.
// ======================================================
const isMobileLandscapeHome =
  isMobile &&
  typeof window !== "undefined" &&
  window.innerWidth > window.innerHeight;

if (isMobileLandscapeHome) {
  return (
    <div
      style={{
        position: "fixed",
  ...
  100% {
    ...
    opacity: 0;
      ...
      >
        Turn your phone vertically to access the Home screen.
      </div>
    </div>
  );
}
...
// ======================================================
// PUBLIC TV — MOBILE PORTRAIT GATE
// Retorno temprano para celular vertical.
// Evita scroll + giro con offset.
// No modifica cálculo, jueces, timer ni overlays.
// ======================================================
const isMobilePortraitPublicTV =
  isMobilePublicTV &&
  typeof window !== "undefined" &&
  window.innerHeight > window.innerWidth;

if (isMobilePortraitPublicTV) {
...
>
  ...
  >
    ...
    >
      Turn your phone sideways to activate the cinematic Public TV broadcast.
    </div>
  </div>
);
}  
