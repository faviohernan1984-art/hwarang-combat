...
const showJudgeWinner =
  ...
  // ======================================================
// JUDGE — MOBILE LANDSCAPE GATE
// Retorno temprano para celular horizontal.
// Mantiene Judge operativo solo en portrait.
// No modifica scoring, overlays ni Firebase.
// ======================================================
const isJudgeMobileLandscape =
  typeof window !== "undefined" &&
  window.innerWidth < 900 &&
  window.innerWidth > window.innerHeight;

if (isJudgeMobileLandscape) {
  return (
    <div
      style={{
        position: "fixed",
    ...
    >
      ...
      >
        Turn your phone vertically to operate the Judge screen.
      </div>
    </div>
  );
}
